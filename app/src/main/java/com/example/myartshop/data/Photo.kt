...
//Artists
//val listOfartists = listOf(Artist(R.string.artist1_name, R.string.artist1_country, R.string.artist1_birth),
//Artist(R.string.artist2_name, R.string.artist2_country, R.string.artist2_birth),
//Artist(R.string.artist3_name, R.string.artist3_country, R.string.artist3_birth),
//Artist(R.string.artist4_name, R.string.artist4_country, R.string.artist4_birth),
//Artist(R.string.artist5_name, R.string.artist5_country, R.string.artist5_birth),
//Artist(R.string.artist6_name, R.string.artist6_country, R.string.artist6_birth))
